...
Galleria.addTheme({
    ...
    M.click(function () {if (ia && c) {v.play();} else {c = ka;v.pause();}Q.animate({top: ia ? v.getStageHeight() + 30 : 0}, {easing: "galleria", duration: 0, complete: function () {v.defineTooltip("thumblink", ia ? R.show_thumbnails : R.hide_thumbnails);M[ia ? "removeClass" : "addClass"]("open");ia = !ia;}});});
    if (s._showPopout) {
